...
import shiftanimate.data.AnimationData.LayerType;
import flixel.math.FlxMath;
import haxe.extern.EitherType;
import shiftanimate.data.AnimationData.Frame;
import flixel.util.FlxDestroyUtil.IFlxDestroyable;
import shiftanimate.data.AnimationData.Layers;
import shiftanimate.interfaces.IFilterable;
import shiftanimate.motion.easing.*;
