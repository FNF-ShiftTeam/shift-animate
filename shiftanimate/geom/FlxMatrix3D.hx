...
/**
 * `FlxMatrix3D` consists of `openfl.geom.Matrix3D` but with a new naming plus some new functions/variables that are convenient to shiftanimate.
 */
